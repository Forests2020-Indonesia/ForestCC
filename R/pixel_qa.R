...
# cirrus
pixqa[['low_cfd_cirrus']] %in% pixqa[['clr']] 
pixqa[['hgh_cfd_cirrus']] %in% pixqa[['clr']] 
# cloud
pixqa[['low_cfd_cloud']] %in% pixqa[['clr']] 
pixqa[['med_cfd_cloud']] %in% pixqa[['clr']] 
pixqa[['med_cfd_cloud']] %in% pixqa[['wtr']] 

pixqa[['hgh_cfd_cloud']] %in% pixqa[['clr']] 
pixqa[['hgh_cfd_cloud']] %in% pixqa[['wtr']]
# cloud shadow
pixqa[['cld_shadow']] %in% pixqa[['clr']] 
